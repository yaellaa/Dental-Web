			...
			<div class="main">
				<div class="nav">
					<table>
						...
						<li><a href="DRS.php"><button class="shs">Senior High</button></a></li>
...
while($res = mysqli_fetch_array($search_result)) {
		...
		echo "<td><a href=\"shschart.php?id=$res[id]\">View</a> | <a href=\"dels.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";
		echo "</tr>";
}
}
