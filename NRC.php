			...
			<div class="main">
				<div class="nav">
					<table>
						...
						<ul>
							...
							<li><a href="NRC.php"><button class="college">College</button></a></li>
				...
				<?php 
					...
					while($res = mysqli_fetch_array($search_result)) {
						...
						echo "<td>" .$res['Year']. "</td>";
						echo "<td><a href=\"collegeview.php?id=$res[id]\">Edit</a> | <a href=\"delc.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";
						echo "</tr>";
					}
				}
