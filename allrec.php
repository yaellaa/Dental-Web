    ...
    <div class="main">
        <div class="nav">
            <table>
                ...
                <tr>
                <?php if(isset($_SESSION["UserLevel"]) && $_SESSION["UserLevel"] == "Nurse"){  ?>
                    <td>Forms
                        <ul>
            ...
            <center>
                <table>
                    ...
                    while ($res = mysqli_fetch_array($search_result)) {
                        ...
                        echo "<td><a href=\"view.php?id=$res[ID]&category=$res[Category]\">View</a> | <a href=\"delete.php?id=$res[ID]&category=$res[Category]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";
                        echo "</tr>";
                    }
                    ?>
                </table>
