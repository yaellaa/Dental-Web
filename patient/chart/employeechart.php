...
{	
	...
	$result1 = mysqli_query($mysqli, "SELECT * FROM employee WHERE id=$id");
...
<body>
		<link href="styles/luh.css" type="text/css" rel="stylesheet"/>
			<div class="content">
			<form action="patient/chart/employeechart.php" method="post">
			<div class="info">
		<table>
			<tr>
			...
			<tr>
				...
				<div class="legend">
				<img src="public/uploads/legends.jpg"/>
				</div>
				</div>
