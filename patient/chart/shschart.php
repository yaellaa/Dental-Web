...
{	
	...
	$result1 = mysqli_query($mysqli, "SELECT * FROM shs WHERE id=$id");
...
<html>
	<head>	
		<title>Senior High (Teeth Chart)</title>
	</head>
	<body>
		<link href="styles/luh.css" type="text/css" rel="styless/stylesheet"/>
			<div class="content">
				<form action="/forms/chart/shschart.php" method="post">
			<div class="info">
		<table>
			<tr>
