...
<html>
<body>
		<link href="public/uploads/blend.css" rel="stylesheet" type="text/css"/>
<center>
<table>
		<?php
		$id = $_GET['id'];
		...
		$result = mysqli_query($mysqli, "SELECT * FROM college WHERE id=$id");
			...
			while($res = mysqli_fetch_array($result)) {
					...
					echo "<br/><br/>";
					echo "<a href=\"patient/edit/collegeedit.php?id=$_GET[id]\">Edit</a>";
					echo "&nbsp&nbsp&nbsp&nbsp";
					echo "<a href=\"forms/nurse/NRC.php\">Go back
					<script></a>";
		?>
</center>
</body>
